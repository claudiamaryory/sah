...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { apellido: @empleado.apellido, celular: @empleado.celular, documento: @empleado.documento, nombre: @empleado.nombre, telefono: @empleado.telefono }
    end
  ...
  test "should update empleado" do
    put :update, id: @empleado, empleado: { apellido: @empleado.apellido, celular: @empleado.celular, documento: @empleado.documento, nombre: @empleado.nombre, telefono: @empleado.telefono }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
