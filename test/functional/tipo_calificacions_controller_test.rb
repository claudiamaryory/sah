...
class TipoCalificacionsControllerTest < ActionController::TestCase
  setup do
    @tipo_calificacion = tipo_calificacions(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:tipo_calificacions)
  end
  ...
  test "should destroy tipo_calificacion" do
    ...
    assert_redirected_to tipo_calificacions_path
  end
end
